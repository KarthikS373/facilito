...
const FormCard: React.FC<FormCardProps> = withStrings(
	({ form, contentLink, bottomLink, bottomSection, $, onDelete }) => {
		// ESTADOS MENU
								...
								<ul>
									<li
										...
										<svg
											...
											<path
												fill={
													form.answersConnection?.methods.includes('whatsapp') ? '#fff' : '#000'
												}
